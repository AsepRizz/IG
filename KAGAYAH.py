...
class Brute:
    ...
    def Logos(self):
        Console().print(f'''
 __    __   ______    ______    ______   __      __   ______          ______   ________   ______   _______   ________ 
/  |  /  | /      \  /      \  /      \ /  \    /  | /      \        /      \ /        | /      \ /       \ /        |
$$ | /$$/ /$$$$$$  |/$$$$$$  |/$$$$$$  |$$  \  /$$/ /$$$$$$  |      /$$$$$$  |$$$$$$$$/ /$$$$$$  |$$$$$$$  |$$$$$$$$/ 
$$ |/$$/  $$ |__$$ |$$ | _$$/ $$ |__$$ | $$  \/$$/  $$ |__$$ |      $$ \__$$/    $$ |   $$ |  $$ |$$ |__$$ |$$ |__    
$$  $$<   $$    $$ |$$ |/    |$$    $$ |  $$  $$/   $$    $$ |      $$      \    $$ |   $$ |  $$ |$$    $$< $$    |   
...
$$ | $$  |$$ |  $$ |$$    $$/ $$ |  $$ |    $$ |    $$ |  $$ |      $$    $$/    $$ |   $$    $$/ $$ |  $$ |$$       |
$$/   $$/ $$/   $$/  $$$$$$/  $$/   $$/     $$/     $$/   $$/        $$$$$$/     $$/     $$$$$$/  $$/   $$/ $$$$$$$$/ 
                                                 𝙒𝙊𝙀 𝙈𝙀𝙈𝙀𝙆 𝙅𝙄𝙆𝘼 𝘼𝘿𝘼 𝙆𝙀𝙇𝙐𝙃𝘼𝙉 𝙏𝘼𝙉𝙔𝘼𝙆𝘼𝙉 𝙎𝘼𝙅𝘼 𝙆𝙀 𝙉𝙊 𝙂𝙒 085871290035                                                                 
...
{self.ipp}''')
    ...
    def methode(self):
        ...
        Console().print(f' {P2}[{H2}1{P2}]. Metode log Api🔥        {P2}[{H2}4{P2}]. Metode log Api_V1')
